...
class WorldCatalogSeeder extends Seeder {
 public function run(){DB::transaction(function(){
  ...
  foreach(['grey_oak_forest','abandoned_mines'] as $zoneCode){ZoneEncounterSize::updateOrCreate(['zone_id'=>$zones[$zoneCode]->id,'enemy_count'=>1],['weight'=>100,'is_active'=>true,'sort_order'=>1]);}

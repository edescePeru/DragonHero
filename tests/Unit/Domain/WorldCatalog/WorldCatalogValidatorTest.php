...
class WorldCatalogValidatorTest extends TestCase {
 ...
 public function test_non_stackable_item_requires_max_stack_one(){ $this->validator()->assertItemStack(false,1);$this->expectException(InvalidArgumentException::class);$this->validator()->assertItemStack(false,2); }

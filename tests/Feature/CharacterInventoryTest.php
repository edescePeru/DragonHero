...
class CharacterInventoryTest extends TestCase {
 ...
 private function player(){ $user=User::factory()->create();$character=Character::factory()->selectedFor($user)->create();return [$user,$character]; }
 ...
 public function test_user_cannot_view_another_inventory(){ list($owner,$character)=$this->player();$other=User::factory()->create();Character::factory()->selectedFor($other)->create();$this->actingAs($other)->get(route('characters.inventory.index',$character))->assertForbidden(); }

<ul class="nav flex-column">
  ...
  <li><a class="nav-link {{ request()->routeIs('characters.*') ? 'active' : '' }}" href="{{ $navigationCharacter ? route('characters.show',$navigationCharacter) : route('characters.create') }}"><i class="ti ti-user"></i><span class="nav-text">Mi personaje</span></a></li>

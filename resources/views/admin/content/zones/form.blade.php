...
<form method="POST" enctype="multipart/form-data" action="{{ $zone->exists?route('admin.content.zones.update',$zone):route('admin.content.zones.store') }}">
@csrf
...
@include('admin.content.zones.partials.combat-background')

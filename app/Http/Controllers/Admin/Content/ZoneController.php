...
public function create(ContentAdminReadService $read){$zone=new Zone();return view('admin.content.zones.form',['zone'=>$zone,'options'=>$read->zoneOptions($zone),'combatBackground'=>$read->zoneBackground($zone)]);}
...
public function edit(Zone $zone,ContentAdminReadService $read){return view('admin.content.zones.form',['zone'=>$zone,'options'=>$read->zoneOptions($zone),'combatBackground'=>$read->zoneBackground($zone)]);}

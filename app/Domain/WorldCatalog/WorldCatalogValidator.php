...
final class WorldCatalogValidator {
    ...
    public function assertItemStack($isStackable,$maxStack){if($isStackable&&($maxStack===null||(int)$maxStack<=0)){throw new InvalidArgumentException('Stackable items require a positive max stack.');}if(!$isStackable&&$maxStack!==null){throw new InvalidArgumentException('Non-stackable items require a null max stack.');}}
